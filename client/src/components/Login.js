...
class Login extends React.Component {
  ...
  render() {
    ...
    if (this.state.mode === 'register') {
      titles = (
        <div>
          <h1 className="title">Carpooling</h1>
          <br />
        </div>
      );
      ...
      form = (
        <form className="form" onSubmit={this.handleRegister}>
          ...
          <br />
          <input type="email" name="email" value={this.state.email} placeholder="INPT E-mail" required pattern="\b[A-Z0-9a-z._%+-]+@inpt\.ac.ma\b" onChange={event => this.setState({ email: event.target.value })} />
          <br />
      ...
      form = (
        <form className="form" onSubmit={this.handleLogin}>
          <input type="email" name="logemail" value={this.state.email} placeholder="E-mail" required pattern="\b[A-Z0-9a-z._%+-]+@inpt\.ac.ma\b" onChange={event => this.setState({ email: event.target.value })} />
          <br />
